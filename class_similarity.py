...
def compute_similarity(word_vectors, words):
	return np.array([[word_vectors.similarity(w1, w2) for w1 in words] for w2 in words])
...
if __name__ == '__main__':
	...
	G = compute_similarity(word_vectors, classes)
	print(G)
	print(G.shape)
